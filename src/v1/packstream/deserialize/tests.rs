...
fn negative_int_into_u64_should_fail() {
    let mut input = Cursor::new(vec![0xFF]);
...
#[test]
#[should_panic(expected = "Expected `I8`")]
fn negative_int_into_u32_should_fail() {
    let mut input = Cursor::new(vec![0xFF]);
    let _: u32 = from_reader(&mut input).unwrap();
}
...
#[test]
#[should_panic(expected = "Expected `I8`")]
fn negative_int_into_u16_should_fail() {
    let mut input = Cursor::new(vec![0xFF]);
    let _: u16 = from_reader(&mut input).unwrap();
}
...
#[test]
#[should_panic(expected = "Expected `I8`")]
fn negative_int_into_u8_should_fail() {
    let mut input = Cursor::new(vec![M::INT_8, 0x80]);
    let _: u8 = from_reader(&mut input).unwrap();
}
...
#[test]
#[should_panic(expected = "Expected `I8`")]
fn negative_small_int_into_u8_should_fail() {
    let mut input = Cursor::new(vec![0xF0]);
    let _: u8 = from_reader(&mut input).unwrap();
}

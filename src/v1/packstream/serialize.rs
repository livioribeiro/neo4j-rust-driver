...
mod tests {
    ...
    fn serialize_struct16() {
        ...
        let expected = vec![m::STRUCT_16, 0x01, 0x00,
    ...
    fn serialize_struct8() {
        ...
        let result = encode(&input).unwrap();
        let expected = vec![m::STRUCT_8, size,
    ...
    fn serialize_tiny_struct() {
        ...
        let result = encode(&input).unwrap();
        let expected = vec![m::TINY_STRUCT_NIBBLE + size,
                            0x81, 0x41, 0x01,
                            0x81, 0x42, m::FLOAT, 0x3F, 0xF1, 0x99, 0x99, 0x99, 0x99, 0x99, 0x9A,
                            0x81, 0x43, 0x81, 0x43];

...
mod tests {
    ...
    fn serialize_tiny_struct() {
        ...
        //         where S: Serializer
        //     {
        //         let mut state = serializer.serialize_struct("MyStruct", 3).unwrap();
        //         serializer.serialize_struct_elt(&mut state, "A", self.A).unwrap();
        //         serializer.serialize_struct_elt(&mut state, "B", self.B).unwrap();
        //         serializer.serialize_struct_elt(&mut state, "C", self.C).unwrap();
